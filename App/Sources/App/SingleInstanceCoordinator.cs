...
namespace MaxLoud
{
    ...
    {
        private const string SemaphoreName = @"Local\RokkyStudio.MaxLoud.SingleInstance";
        private const string ActivationEventName = @"Local\RokkyStudio.MaxLoud.Activate";
